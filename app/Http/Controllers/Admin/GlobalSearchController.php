...
{
    private $models = [
        'Branch'         => 'cruds.branch.title',
        'Brand'          => 'cruds.brand.title',
        'PurchaseSource' => 'cruds.purchaseSource.title',
        'Needle'         => 'cruds.needle.title',
        'Made'           => 'cruds.made.title',
        'Sparepart'      => 'cruds.sparepart.title',
        'DoubleTape'     => 'cruds.doubleTape.title',
        'Spray'          => 'cruds.spray.title',
        'Frame'          => 'cruds.frame.title',
        'ThreadType'     => 'cruds.threadType.title',
        'Thread'         => 'cruds.thread.title',
        'Interline'      => 'cruds.interline.title',
    ];
