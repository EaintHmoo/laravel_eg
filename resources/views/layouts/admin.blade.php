...
<head>
    ...
    <link href="https://cdn.datatables.net/v/bs5/dt-1.13.6/b-2.4.1/b-html5-2.4.1/fh-3.4.0/datatables.min.css"
        rel="stylesheet">
...
<body>
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            {{-- nav and search --}}
            <nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme noprint"
                id="layout-navbar">
                                ...
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="d-flex align-items-center">
                                        @if (Auth::user()->is_admin)
                                            <div class="me-3">{{ Auth::user()->name }} (Main)</div>
                                        @else
                                        <div class="me-3">{{ Auth::user()->name }} {{ Auth::user()->branch ? '(' . Auth::user()->branch->name . ')' : '' }}</div>
                                        @endif
    ...
    <script src="{{ asset('frestui/assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.js') }}">
    </script>
    ...
    <script src="https://cdn.datatables.net/v/bs5/dt-1.13.6/b-2.4.1/b-html5-2.4.1/fh-3.4.0/datatables.min.js"></script>
