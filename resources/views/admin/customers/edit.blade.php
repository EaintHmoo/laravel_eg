        ...
        <form method="POST" action="{{ route("admin.customers.update", [$customer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('attention_person') ? 'is-invalid' : '' }}" type="text" name="attention_person" id="attention_person" value="{{ old('attention_person', $customer->attention_person) }}" required>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('factory_name') ? 'is-invalid' : '' }}" type="text" name="factory_name" id="factory_name" value="{{ old('factory_name', $customer->factory_name) }}" required>
